...
function Skills() {
  return (
    <section
      id="skills"
      className="py-20 px-6 bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 text-white"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 animate-fade-in-up">
          {Object.entries(skills).map(([category, skillList], i) => (
            <div
              key={category}
              className="bg-gray-900 border border-gray-700 p-6 rounded-xl shadow hover:shadow-md transform transition duration-300 hover:scale-[1.02]"
              style={{ animationDelay: `${i * 0.1}s` }}
            >
              <h3 className="text-xl font-semibold text-teal-400 mb-4 border-b border-gray-700 pb-2">
